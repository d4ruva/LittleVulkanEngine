...
namespace lve
{
	...
	{
		assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "Cannot Create graphics pipeline: no pipleine layout provided in config info");
		assert(configInfo.renderPass != VK_NULL_HANDLE && "Cannot Create graphics pipeline: no pipleine renderepass provided in config info");
